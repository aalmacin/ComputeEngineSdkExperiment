...
public class CreateInstanceGroup {
...
//                    .build();
            ...
            InsertInstanceGroupRequest insertInstanceRequest = InsertInstanceGroupRequest.newBuilder()
                    .setProject(project)
                    .setZone(zone)
                    .setInstanceGroupResource(instanceGroup)
                    .build();

            OperationFuture<Operation, Operation> operation = instanceGroupsClient.insertAsync(insertInstanceRequest);

            // Wait for the operation to complete
            Operation response = operation.get(4, TimeUnit.MINUTES);
